...
def main(argv):
    split_vcf_file("1kGP/1kGP_chr1_SV.vcf.gz".replace("chr1",argv[0]),"1kGP/1kGP_chr1_SV.260.target.vcf".replace("chr1",argv[0]),"1kGP/1kGP_chr1_SV.260.answer.vcf".replace("chr1",argv[0]),0.5)
